          ...
          <div className="row ">
            ...
            <div className="col-md-6">
              <div className="card-body">
                ...
                {ownListing ? (
                  <div>
                    <button type="button" className="btn btn-info mt-4 mb-4 btn-primary" data-bs-toggle="modal" data-bs-target="#editModal" onClick={editListing}>
                      Edit
                    </button>
                      ...
                      <div className="modal-dialog">
                        <div className="modal-content">
                          <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Edit Listing</h5>
                          ...
                          <div className="modal-footer">
                            ...
                            <button type="submit" className="btn btn-primary" onClick={update}>Save changes</button>
                          </div>
                        </div>
                      </div>
                    </div>
